...
if not exist %TOMCAT_HOME%\bin (
    ...
    rmdir /S /Q %TOMCAT_HOME%\webapps\docs
    rmdir /S /Q %TOMCAT_HOME%\webapps\examples
    rmdir /S /Q %TOMCAT_HOME%\webapps\host-manager
    rmdir /S /Q %TOMCAT_HOME%\webapps\manager
